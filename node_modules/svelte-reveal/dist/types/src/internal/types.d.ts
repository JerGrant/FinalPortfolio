 ...
 */
export declare type Devices = [string, IDevice][];
/**
 ...
 */
export declare type Device = 'mobile' | 'tablet' | 'laptop' | 'desktop';
/**
 ...
 */
export declare type Transition = 'fly' | 'fade' | 'blur' | 'scale' | 'slide' | 'spin';
/**
 * The types of supported easing functions that can be used to tweak the timing of a transition.
 */
export declare type Easing = 'linear' | 'easeInSine' | 'easeOutSine' | 'easeInOutSine' | 'easeInQuad' | 'easeOutQuad' | 'easeInOutQuad' | 'easeInCubic' | 'easeOutCubic' | 'easeInOutCubic' | 'easeInQuart' | 'easeOutQuart' | 'easeInOutQuart' | 'easeInQuint' | 'easeOutQuint' | 'easeInOutQuint' | 'easeInExpo' | 'easeOutExpo' | 'easeInOutExpo' | 'easeInCirc' | 'easeOutCirc' | 'easeInOutCirc' | 'easeInBack' | 'easeOutBack' | 'easeInOutBack' | 'custom';
/**
 * The individual weights of a custom cubic-bezier curve.
 */
export declare type CustomEasing = [number, number, number, number];

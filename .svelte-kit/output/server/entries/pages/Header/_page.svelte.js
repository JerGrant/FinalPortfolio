...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header><div class="${"navWrapper"}">${validate_component(Page$1, "LogoData").$$render($$result, {}, {}, {})}
    ...
    <div class="${"imgWrapper"}"><a href="${"https://github.com/JerGrant"}" target="${"_blank"}" rel="${"noopener noreferrer"}" class="${"tooltip"}"><img${add_attribute("src", github, 0)} alt="${"GitHub"}"> <span class="${"tooltiptext"}">Visit my Github!</span></a>
